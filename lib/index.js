...
var LinesEllipsis = function (_React$PureComponent) {
  ...
  _createClass(LinesEllipsis, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      var winWidthChanged = nextProps.winWidth !== this.props.winWidth;
      var textChanged = nextProps.text !== this.props.text;
      var needsUpdate = winWidthChanged || textChanged;
    ...
    value: function reflow(props) {
      ...
      this.setState({
        ...
        return props.onClamp && props.onClamp(clamped);
      });
    }
  }, {
    key: 'calcIndexes',
    ...
    value: function render() {
      ...
      var clamped = this.state.clamped;
      ...
      var text = clamp ? this.state.text : this.props.text;
      var showEllipsis = clamp && clamped;
      return React.createElement(
        ...
        showEllipsis && React.createElement(
          'span',
